...
For the most part, the entire engine has been written 
generally to be used as a library. I am trying to 
build out the API as a composable pipeline system.
...
- For now, gaps are syntactical sugar that are not 
  ...
  definitely change.
- A LLM was used to assist with code refactoring. These
  commits have been marked as such. All other code was 
